...
{
   class ScrMediaSubsession : public OnDemandServerMediaSubsession
   {
   public:
      static ScrMediaSubsession* createNew(UsageEnvironment& env, StreamReplicator* replicator);
   ...
   protected:
      ScrMediaSubsession(UsageEnvironment& env, StreamReplicator* replicator)
